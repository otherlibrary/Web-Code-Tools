(function () {
  ...
  .controller('OpenGraphRestaurantMenuItemController', ['generalService', function(generalService) {
    this.data = {
      title: '',
      url: '',
      section: '',
    ...
    this.elementHtml = function() {
      ...
      html += '\n<meta property="restaurant:section" content="' + this.data.section + '">';
      html += '\n<meta property="restaurant:variation:price:amount" content="' + this.data.price + '">';
      html += '\n<meta property="restaurant:variation:price:currency" content="' + this.data.currency + '">';
