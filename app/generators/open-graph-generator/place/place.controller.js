(function () {
  ...
  .controller('OpenGraphPlaceController', ['generalService', function(generalService) {
    this.data = {
      title: '',
      url: '',
      lat: '',
    ...
    this.elementHtml = function() {
      ...
      html += '<meta property="og:type" content="place">';
      ...
      html += '\n<meta property="place:location:latitude" content="' + this.data.lat + '">';
      html += '\n<meta property="place:location:longitude" content="' + this.data.long + '">';
