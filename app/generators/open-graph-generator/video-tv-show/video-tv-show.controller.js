(function () {
  ...
  .controller('OpenGraphVideoTvShowController', ['generalService', function(generalService) {
    this.data = {
      title: '',
      url: '',
      releaseDate: '',
    ...
    this.elementHtml = function() {
      ...
      html += '<meta property="og:type" content="video.tv_show">';
      ...
      if (this.data.releaseDate) {
        html += '\n<meta property="video:release_date" content="' + this.data.releaseDate + '">';
      }
