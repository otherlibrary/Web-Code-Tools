(function () {
  ...
  .controller('OpenGraphGameAchievementController', ['generalService', function(generalService) {
    this.data = {
      title: '',
      url: '',
      numImages: '1',
    ...
    this.elementHtml = function() {
      ...
      html += '<meta property="og:type" content="game.achievement">';
      ...
      html += '\n<meta property="game:points" content="' + this.data.points + '">';
